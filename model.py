...
class Predictor(nn.Module):
    def __init__(self, encoder, decoder, device, ags_dim=20):
        super().__init__()
    ...
    def forward(self, ag_s, ab_s, ag_m_s, ab_m_s, ag_s_num, ab_s_num, ag_m_s_num, ab_m_s_num, itera, correct_interaction):
    ...
    def train(self, dataset, device, itera):
        ...
        for data in dataset:
            ...
            if i % self.batch == 0 or i == N:
                ...
                loss, correct, predicted = self.model(data_pack, itera)  # predictor.train()
